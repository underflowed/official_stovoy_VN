...
label endoftacosaga:
    ...
    "The countless amounts of unimaginable perils that stovoy has faced in this entire ordeal has left him tired, hungry, and alone."
    "and so he went home, for shelter, comfort, and acceptence. Also he had to build a computer, thus let us watch the pc building stream."


    s "guys I just got these new parts and they're the fucking shit."
    t "dude why does the front io on your old motherboard look more modern than the new one"
    s "..."
    s "I got a ram fan tho..."
    t "shit you right"
    s "kinda stressed now tho... lets play some {i}l o - f i"
    play music "lofi.mp3"
    "Now stovoy spends a solid hour of his time replacing a motherboard"
    "Seriously though 10 fucking minutes on a cpu power cable like my dude..."
    s "{i} Pulls out cable from 90's{/b}"
